...
The interaction of positive feedback, input noise and external LC is siginficant. Test whether excluding this interaction improves model fit or not.
...
```
We can safely continue with the simpler model, excluding the interactino of input noise and internal LoC.
