...
The is no significant main effect of CESDR, but it is involved in a significant interaction effect and it's a numeric variable. We will just leave the effect in the model. This is our final fixed effects structure. Now we can start to explore random effects structure.
