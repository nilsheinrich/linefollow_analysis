...
# Easy analysis because it doesn't pay out if you put in effort to only report robust effects...
...
# Save to CSV
write.csv(bootstrap_performance_df, "bootstrap_performance_results.csv", row.names = FALSE)
...
# Save to CSV
write.csv(bootstrap_soc_df, "bootstrap_soc_results.csv", row.names = FALSE)
