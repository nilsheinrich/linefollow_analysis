...
```{r negFeedback vs. posFeedback, echo=FALSE}
...
t.test(negative_feedback.diffs, positive_feedback.diffs, alternative = "greater", paired=TRUE)
...
t.test(input_noise.diffs, negative_feedback.diffs, alternative = "less", paired=TRUE)
